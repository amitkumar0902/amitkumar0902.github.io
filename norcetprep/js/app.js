// NORCET Excellence Hub - Main JavaScript

(function() {
    var KEY = 'norcet-theme';
    ...
    window.NORCET_toggleTheme = toggleTheme;
})();

// Initialize app when DOM is loaded
document.addEventListener('DOMContentLoaded', function() {
    var btn = document.getElementById('theme-toggle');
    if (btn) btn.addEventListener('click', window.NORCET_toggleTheme);

    console.log('NORCET Excellence Hub loaded');
