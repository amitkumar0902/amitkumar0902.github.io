// NORCET Static Topic Loader - Fetches JSON and renders question cards for GitHub Pages
(function() {
    var topic = (function() {
    ...
    if (!topic || topic === 'mock-test' || topic === 'revision') {
        window.dispatchEvent(new Event('norcet-questions-loaded'));
        return;
    }
    ...
    // From /norcetprep/topics/xxx.html -> ../data/questions/xxx.json
    ...
    fetch(dataUrl)
        ...
        .catch(function(err) {
            ...
            console.error('NORCET topic-loader:', err);
            window.dispatchEvent(new Event('norcet-questions-loaded'));
        });
